...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Estoque
        <small>Controle de itens e ingredientes no estoque</small>
      </h1><!--
      <ol class="breadcrumb">
          ...
          <table class="table table-striped table-hover" id="tabela-estoque">
            <thead>
                <tr>
                    ...
                    <th> <strong>Preço unitário (R$)</strong> </th>
                    <th> <strong>Data da ultima modificação</strong> </th>
                    <th>  </th>
                    <th>  </th>
                </tr>
            </thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <button type="button"   data-id="<?php echo $aux[id_produto]?>" 
                                                    ...
                                                    class="open-ModificaDialog btn btn btn-default" data-toggle="modal" data-target="#modificar_item_estoque">
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <button type="button"   data-id="<?php echo $aux[id_produto]?>" 
                                                    class="open-DeletaDialog btn btn btn-default" data-toggle="modal" data-target="#deletar_item_estoque">
