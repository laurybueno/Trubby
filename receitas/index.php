                ...
                <tr>
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <a href="../receitas/detalhes.php?id_produto=<?= $aux[id_produto]?>" class="btn btn-default">
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <a href="../receitas/modificar.php?id_produto=<?= $aux[id_produto]?>" class="btn btn-default">
