...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Receitas
        <small>Controle de Receitas</small>
      </h1><!--
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="box">
        <div class="box-header">
          <div class="pull-right">
            <a href="insere_receita.php" class="btn btn btn-default"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Inserir novo item</a>
          </div>
        </div>    
        <div class="box-body">
          <table class="table table-striped table-hover" id="tabela-estoque">
            <thead>
                <tr>
                    ...
                    <th> <strong>Nome da Receita</strong> </th>
                    <th>  </th>
                    <th>  </th>
                    <th>  </th>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <a href="../receitas/detalhes_receita.php?id_produto=<?= $aux[id_produto]?>" class="btn btn-default">
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <a href="../receitas/modifica_receita.php?id_produto=<?= $aux[id_produto]?>" class="btn btn-default">
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <button type="button" data-id="<?= $aux[id_produto]?>" class="open-DeletaDialog btn btn btn-default" data-toggle="modal" data-target="#deletar_receita">
        ...
        <div class="box-footer">
          <div class="pull-right">
            <a href="insere_receita.php" class="btn btn-default"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Inserir novo item</a>
          </div>
        </div> 
      </div>      
