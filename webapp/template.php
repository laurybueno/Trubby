  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-book"></i> <span>Receitas</span></a></li>
        <li><a href="#"><i class="fa fa-cutlery"></i> <span>Cardapio</span></a></li>
        <li><a href="#"><i class="fa fa-money"></i> <span>Caixa</span></a></li>
