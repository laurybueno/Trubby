...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cardápio
        <small>Controle de itens no Cardápio</small>
      </h1><!--
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="box">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <button type="button"   data-id="<?php echo $aux['id_produto']?>" 
                                                    ...
                                                    class="open-ModificaDialog btn btn-default" data-toggle="modal" data-target="#modificarItemCardapio">
                    ...
                    <td>
                        <form class="form-horizontal"  action="" role="form" method="POST">
                            <button type="button"   data-id="<?php echo $aux['id_produto']?>" 
                                                    class="open-DeletaDialog btn btn-default" data-toggle="modal" data-target="#deletarItemCardapio">
        ...
        <div class="box-footer">
          <div class="pull-right">
            <a href="insereCardapio.php" class="btn btn-default"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Inserir novo item</a>
          </div>
        </div> 
      </div>      
