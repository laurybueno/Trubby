...
<head>
  ...
  <title>Trubby | Inserir item no Cardápio</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cardápio
        <small>Inserir item no Cardapio</small>
      </h1><!--
      <ol class="breadcrumb">
        ...
        <div class="box-body">
          <!-- CONTEUDO -->
            <form class="form-horizontal" role="form" method="POST">
                ...
                <div class="form-group">        
                    <div align="center">
                        <input id="submit" name="submitted" type="submit" value="Inserir no Cardapio" class="btn btn-success">
                    </div>
                </div>
            </form>          
        </div>
